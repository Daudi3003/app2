@props(['name' => 'circle', 'size' => 18, 'stroke' => 2])

{{--
    LearnHub icon set — inline SVG, no external icon library, no extra HTTP
    request and no npm dependency. Add new glyphs to the match below.
    Usage: <x-icon name="book" :size="20" />
--}}
